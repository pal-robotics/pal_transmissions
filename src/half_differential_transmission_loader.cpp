  ...
  const hardware_interface::TransmissionInfo & transmission_info)
{
    try
    {
        ...
        {
            actuator_roles["actuator1"] = 0;
            actuator_roles["actuator2"] = 1;
        }
        else if (act_role1 == "actuator2" && act_role2 == "actuator1")
        {
            actuator_roles["actuator1"] = 1;
            actuator_roles["actuator2"] = 0;
        }
        else
        {
        ...
        {
            joint_roles["joint1"] = 0;
            joint_roles["joint2"] = 1;
        }
        else if (jnt_role1 == "joint2" && jnt_role2 == "joint1")
        {
            joint_roles["joint1"] = 1;
            joint_roles["joint2"] = 0;
        }
        else
        {
        ...
        std::shared_ptr<transmission_interface::Transmission> transmission(new pal_transmissions::HalfDifferentialTransmission(
